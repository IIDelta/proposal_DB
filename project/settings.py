...
SECRET_KEY = 'django-insecure-66_wq1e16hopwkb_qv!zt0n3l^jchobq1jmz_)a+oet1p5e!_k'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # This will also look for templates inside each app's "templates" subfolder
        'OPTIONS': {
            'context_processors': [
